...
const filters = [
  {
    ...
    options: [
      ...
      { value: 'FIG', label: 'FIG', checked: false },
      { value: 'ALDO', label: 'ALDO', checked: false },
      { value: 'AVAASA', label: 'AVAASA', checked: false },
      { value: 'DNMX', label: 'DNMX', checked: false },
    ],
  },
  {
    id: 'price',
    ...
    options: [
      ...
      { value: '15,20', label: '$15 - $20', checked: false },
      { value: '20,30', label: '$20 - $30', checked: false },
      { value: '30,1000', label: '$30+', checked: false },
    ],
  },
  {
    id: 'discount',
  ...
  },
  {
    ...
    options: [
      ...
      { value: 2, label: '2⭐ and above', checked: false },
      { value: 3, label: '3⭐ and above', checked: false },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'Vogue Threads Boutique',  label: 'Vogue Threads Boutique',  checked: false },
      { value: 'Urban Chic Apparel Co.',  label: 'Urban Chic Apparel Co.',  checked: false },
      { value: 'Trendy Toggery Emporium',  label: 'Trendy Toggery Emporium',  checked: false  },
      { value: 'Couture Haven Boutique',  label: 'Couture Haven Boutique',  checked: false },
      { value: 'Dapper Styles Depot',  label: 'Dapper Styles Depot',  checked: false  },
    ],
  },
]
