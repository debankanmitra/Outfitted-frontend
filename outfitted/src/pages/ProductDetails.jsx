            ...
            <div className="sticky top-0 overflow-hidden ">
              <div className="relative mb-6 lg:mb-10 lg:h-96">
                <a  className="absolute left-0 transform lg:ml-2 top-1/2 translate-1/2"  href="/"  >
                  <svg  xmlns="http://www.w3.org/2000/svg"  width="16"  height="16"  fill="currentColor"  className="w-5 h-5 text-blue-500 bi bi-chevron-left"  viewBox="0 0 16 16"  >
                ...
                <a  className="absolute right-0 transform lg:mr-2 top-1/2 translate-1/2"  href="/"  >
                  <svg  xmlns="http://www.w3.org/2000/svg"  width="16"  height="16"  fill="currentColor"  className="w-5 h-5 text-blue-500 bi bi-chevron-right "  viewBox="0 0 16 16"  >
              ...
              <div className="flex-wrap hidden -mx-2 md:flex">
                <div className="w-1/2 p-2 sm:w-1/4">
                  <a  className="block border border-gray-200 hover:border-blue-400"  href="/"  >
            ...
            <div className="lg:pl-20">
              <div className="mb-6 ">
                ...
                <div className="flex flex-wrap items-center mb-6">
                  <ul className="flex mb-4 mr-2 lg:mb-0">
                    <li>
                      <a href="/">
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="16"  height="16"  fill="currentColor"  className="w-4 mr-1 text-red-50 bi bi-star "  viewBox="0 0 16 16"  >
                  ...
                  <a  className="mb-4 text-xs underline hover:text-blue-60 lg:mb-0"  href="/"  >
                    See all reviews
                  </a>
                </div>
              ...
              <div className="py-6 mb-6 border-t border-b border-gray-200">
                ...
                <p className="mt-2 text-sm text-blue-500 ">
                  Ships from china.&nbsp;
                  <span className="text-gray-60">  {" "}  Most customers receive within 3-31 days.{" "}  </span>
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center mb-6">
                <div className="mb-4 mr-4 lg:mb-0">
                  <div className="w-28">
                    <div className="relative flex flex-row w-full h-10 bg-transparent rounded-lg">
                      ...
                      <input  type="number"  className="flex items-center w-full font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-100 outline-non focus:outline-none text-md hover:text-black"  placeholder="1"/>
                ...
                <a  href="/"  className="w-full px-4 py-3 text-center text-blue-600 bg-blue-100 border border-blue-600 hover:bg-blue-600 hover:text-gray-100 lg:w-1/2 rounded-xl"  >
                  Add to cart
                </a>
              </div>
              <div className="flex gap-4 mb-6">
                <a  href="/"  className="w-full px-4 py-3 text-center text-gray-100 bg-blue-600 border border-transparent hover:border-blue-500 hover:text-blue-700 hover:bg-blue-10  rounded-xl"  >
                  Buy now
                </a>
              </div>
            </div>
