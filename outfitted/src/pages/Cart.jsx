  ...
  <div className="flex flex-wrap items-center -mx-4 mb-8">
    <div className="w-full px-4 mb-6 md:w-4/6 lg:w-6/12 md:mb-0">
      <div className="flex flex-wrap items-center -mx-4">
        ...
        <div className="w-2/3 px-4">
          <h2 className="mb-2 text-xl font-bold dark:text-gray-400">{name}</h2>
          <p className="text-gray-500 dark:text-gray-400">{description}</p>
        </div>
      </div>
    </div>
    <div className="hidden px-4 lg:block lg:w-2/12">
      <p className="text-lg font-bold text-purple-500 dark:text-gray-400">
        ${price}
      </p>
      {/* Add any additional price details if needed */}
    </div>
    <div className="w-auto px-4 md:w-1/6 lg:w-2/12">
      <div className="inline-flex items-center px-4 font-semibold text-gray-500 border border-gray-200 rounded-md dark:border-gray-700">
        <button className="py-2 hover:text-gray-700 dark:text-gray-400">
    ...
    <div className="w-auto px-4 text-right md:w-1/6 lg:w-2/12">
      ...
      {/* Add any additional subtotal details if needed */}
    </div>
  </div>
);
Product.propTypes = {
...
export const CartSection = () => {
  // Replace this with your actual JSON response
  const products = [
    {
      id: 1,
    ...
    <section className="flex items-center bg-stone-200 lg:h-screen font-poppins dark:bg-gray-700">
      <div className="justify-center flex-1 px-4 py-6 mx-auto max-w-7xl lg:py-4 md:px-6">
        <div className="p-8 bg-gray-50 dark:bg-gray-800">
          ...
          {/* Add coupon input and summary components here */}
        </div>
      </div>
    </section>
  );
